...
let layout content =
    Html.html [
        Html.head [
            ...
            Html.link [
                prop.rel "stylesheet"
                prop.href "https://unpkg.com/tailwindcss@^2.0/dist/tailwind.min.css"
            ]
            Html.script [
                prop.src "https://unpkg.com/turbolinks@5.2.0/dist/turbolinks.js"
            ]
        ]
        Html.body [
            Html.div [
            ...
            Html.script [
                prop.src "https://unpkg.com/htmx.org@1.0.2/dist/htmx.min.js"
            ]
        ]
    ]
